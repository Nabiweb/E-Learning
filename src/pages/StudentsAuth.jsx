...
const StudentsAuth = () => {
  ...
  return (
    <div className='p-5 h-screen flex flex-col justify-between'>
      ...
      <div className='py-5'>
        <Link to='/teachers-auth' className='bg-[#10b461] flex item-center justify-center text-white font-semibold mb-5 rounded px-2 py-2 w-full text-lg placeholder:text-base'>
        Sign Up as a Teacher's</Link>
      </div>
    </div>
  );
};
